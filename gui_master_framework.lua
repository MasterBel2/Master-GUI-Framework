...
--
-- Allows group-drawing text objects. Text objects must be registered every frame they wish to be drawn by calling `activeTextGroup:AddElement(textObject)`. 
-- Text objects must implement the following interface:
-- - textObject._readOnly_font: a font object, generated by `framework:Font()`
-- - textObject:DrawForReal(glFont): draws the text object, providing only the font object's glfont. The text object should use its own cached coordinates to draw.
--
